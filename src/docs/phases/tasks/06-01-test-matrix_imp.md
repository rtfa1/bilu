...
Task: `src/docs/phases/tasks/06-01-test-matrix.md`

This plan defines the automated test coverage for a shell-only board CLI while explicitly excluding full-screen TUI interaction testing (manual only). It aligns with `src/docs/research/shell-only-cli-advanced-notes.md`: command-oriented tests, deterministic output (NO_COLOR, fixed widths), and no runtime third-party deps.
...
- The test matrix is documented here and referenced from `tests/run.sh` or `src/docs/phases/06-testing-and-docs.md`.
...
- `src/docs/phases/tasks/06-01-test-matrix.md`
