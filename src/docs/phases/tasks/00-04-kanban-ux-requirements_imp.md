...
Task: `src/docs/phases/tasks/00-04-kanban-ux-requirements.md`

This implementation plan defines a concrete UX spec for both non-interactive output and the interactive TUI, aligned with the project constraints and the terminal/TUI guidance in `src/docs/research/shell-only-cli-advanced-notes.md`.
...
- `src/docs/phases/tasks/00-04-kanban-ux-requirements.md`
