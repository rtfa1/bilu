...
Task: `src/docs/phases/tasks/03-03-kanban-layout-algorithm.md`
...
- `src/docs/phases/tasks/00-04-kanban-ux-requirements_imp.md` (card structure + degradation)
- `src/docs/phases/tasks/03-02-color-theme-and-no-color_imp.md` (NO_COLOR rules)
- `src/docs/research/shell-only-cli-advanced-notes.md` (avoid `tput` in hot loops; build output buffers; portability)
...
The kanban renderer consumes **normalized TSV v1** (see `02-06-internal-record-format_imp.md`):
...
- `src/docs/phases/tasks/03-03-kanban-layout-algorithm.md`
- `src/docs/phases/tasks/03-04-kanban-narrow-fallback.md`
- `src/docs/phases/tasks/03-05-column-mapping-config.md`
- `src/docs/phases/tasks/00-04-kanban-ux-requirements_imp.md`
