...
Task: `src/docs/phases/tasks/04-03-layout-and-selection-model.md`
...
- Input: normalized TSV v1 (see `src/docs/phases/tasks/02-06-internal-record-format_imp.md`).
- Column mapping: consistent with `src/docs/phases/tasks/03-05-column-mapping-config_imp.md`.
...
- `src/docs/phases/tasks/04-03-layout-and-selection-model.md`
- `src/docs/phases/tasks/03-05-column-mapping-config_imp.md`
