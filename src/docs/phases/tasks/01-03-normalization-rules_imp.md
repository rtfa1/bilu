...
Task: `src/docs/phases/tasks/01-03-normalization-rules.md`
...
- the board audit (`src/docs/phases/tasks/00-02-board-data-audit_imp.md`)
- the schema and TSV contract (`src/docs/phases/tasks/01-02-normalized-task-schema_imp.md`)
- the shell guidance (`src/docs/research/shell-only-cli-advanced-notes.md`): normalize early, keep TSV unambiguous, warn but don’t crash.
...
- `src/docs/phases/tasks/00-02-board-data-audit_imp.md`
- `src/docs/phases/tasks/01-02-normalized-task-schema_imp.md`
