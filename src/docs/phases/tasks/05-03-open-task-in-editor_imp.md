...
Task: `src/docs/phases/tasks/05-03-open-task-in-editor.md`

This implementation plan provides a single, consistent “open task” action used by both the TUI and any future non-interactive commands. It matches the open behavior defined in `04-07-open-and-edit-actions_imp.md` and ensures terminal state is restored properly when the TUI launches an editor.
...
- `src/docs/phases/tasks/05-03-open-task-in-editor.md`
