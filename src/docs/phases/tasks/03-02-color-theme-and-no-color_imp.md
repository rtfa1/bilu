...
Task: `src/docs/phases/tasks/03-02-color-theme-and-no-color.md`
...
- `src/docs/research/shell-only-cli-advanced-notes.md` (NO_COLOR, non-TTY auto-disable, stable tests)
- `src/docs/phases/tasks/00-04-kanban-ux-requirements_imp.md` (initial theme proposal)
- `src/docs/phases/tasks/03-01-table-view-spec_imp.md` (colorize tokens only, don’t break alignment)
