...
Task: `src/docs/phases/tasks/01-04-json-and-markdown-parsing-strategy.md`

This implementation plan chooses a parsing approach that is portable, maintainable, and consistent with `src/docs/research/shell-only-cli-advanced-notes.md`: avoid runtime JSON parsing in shell when possible, prefer “compile”/derive an internal TSV, and use `awk` for structured transforms.
...
- `src/docs/phases/tasks/01-04-json-and-markdown-parsing-strategy.md`
