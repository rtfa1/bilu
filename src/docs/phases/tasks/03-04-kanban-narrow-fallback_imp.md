...
Task: `src/docs/phases/tasks/03-04-kanban-narrow-fallback.md`

This implementation plan defines the fallback rendering for `--view=kanban` when the terminal is too narrow for a multi-column grid. The fallback must remain readable, avoid wrapping/border breakage, and avoid spamming escape sequences. It complements the wide-mode algorithm in `03-03-kanban-layout-algorithm_imp.md`.
...
- `src/docs/phases/tasks/03-07-renderer-tests.md`
- `src/docs/phases/tasks/03-02-color-theme-and-no-color_imp.md`
