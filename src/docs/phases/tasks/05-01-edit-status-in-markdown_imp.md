...
Task: `src/docs/phases/tasks/05-01-edit-status-in-markdown.md`

This implementation plan implements safe status updates by editing `src/board/tasks/*.md` (source of truth). It follows the shell-only guardrails from `src/docs/research/shell-only-cli-advanced-notes.md`:
- temp file + atomic `mv`
...
- `src/docs/phases/tasks/05-01-edit-status-in-markdown.md`
- `src/docs/phases/tasks/01-03-normalization-rules_imp.md`
