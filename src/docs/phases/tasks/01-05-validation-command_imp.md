...
Task: `src/docs/phases/tasks/01-05-validation-command.md`

This implementation plan defines the `--validate` contract (output + exit codes) and how it relates to normalization. It follows `src/docs/research/shell-only-cli-advanced-notes.md`:
...
- `src/docs/phases/tasks/01-05-validation-command.md`
