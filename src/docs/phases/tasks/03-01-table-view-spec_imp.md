...
Task: `src/docs/phases/tasks/03-01-table-view-spec.md`

This implementation plan defines an exact, testable output contract for `bilu board --list` (table view). It aligns with:
- `src/docs/phases/03-rendering-table-and-kanban.md` (rendering requirements)
- `src/docs/research/shell-only-cli-advanced-notes.md` (NO_COLOR, stable output for tests, awk-friendly pipelines)
...
2) Consume normalized TSV v1 (from `02-06-internal-record-format_imp.md`):
...
- `src/docs/phases/tasks/03-01-table-view-spec.md`
- `src/docs/phases/03-rendering-table-and-kanban.md`
