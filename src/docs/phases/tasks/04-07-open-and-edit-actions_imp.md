...
Task: `src/docs/phases/tasks/04-07-open-and-edit-actions.md`
...
- `src/docs/phases/tasks/04-07-open-and-edit-actions.md`
- `src/docs/phases/tasks/05-01-edit-status-in-markdown.md`
- `src/docs/phases/tasks/05-02-edit-priority-in-markdown.md`
