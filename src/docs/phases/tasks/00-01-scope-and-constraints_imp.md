...
Task: `src/docs/phases/tasks/00-01-scope-and-constraints.md`

This implementation plan turns the Phase 00 “scope and constraints” checklist into concrete repo policies and acceptance checks, using guidance from `src/docs/research/shell-only-cli-advanced-notes.md`.
...
1) Add a single “constraints policy” section to docs:
   - Preferred location: `src/docs/phases/00-board-ui-overview.md` (or `src/docs/README.md`), with bullet-point non-negotiables.
...
- `src/docs/phases/00-board-ui-overview.md`
- `src/docs/phases/tasks/00-01-scope-and-constraints.md`
