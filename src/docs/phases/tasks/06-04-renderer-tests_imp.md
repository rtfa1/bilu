...
Task: `src/docs/phases/tasks/06-04-renderer-tests.md`

This plan adds stable tests for non-interactive renderer outputs (table + kanban) without relying on ANSI formatting or host terminal quirks. It reuses the test strategy defined in `src/docs/phases/tasks/03-07-renderer-tests_imp.md` and follows `src/docs/research/shell-only-cli-advanced-notes.md` (NO_COLOR, deterministic width, command-oriented assertions).
...
- `src/docs/phases/tasks/06-04-renderer-tests.md`
- `src/docs/phases/tasks/03-07-renderer-tests_imp.md`
