...
- `src/board/tasks/00-04-kanban-ux-requirements_imp.md` (card structure + degradation)
- `src/board/tasks/03-02-color-theme-and-no-color_imp.md` (NO_COLOR rules)
...
- `src/board/tasks/00-04-kanban-ux-requirements_imp.md`
