...
- `src/board/tasks/00-04-kanban-ux-requirements_imp.md` (initial theme proposal)
- `src/board/tasks/03-01-table-view-spec_imp.md` (colorize tokens only, don’t break alignment)
...
- `src/board/tasks/03-01-table-view-spec_imp.md`
