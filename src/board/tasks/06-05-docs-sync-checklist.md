# Phase 06 — Docs sync checklist

## Goal

Keep docs in sync with the implementation as the CLI evolves.
...
- Docs match behavior and can be used as the primary user guide.
---
...
Task: `src/board/tasks/06-05-docs-sync-checklist.md`
...
- `src/board/phases/02-cli-and-modules.md` (command/module structure)
- `src/board/phases/03-rendering-table-and-kanban.md` (views + rendering contracts)
- `src/board/phases/04-interactive-tui.md` (TUI behaviors)
- `src/board/phases/05-persistence-and-editing.md` (writes, locks, atomic edits)
- `src/board/phases/06-testing-and-docs.md` (test policy)

4) Ensure tasks link correctly:
- each `src/board/phases/*.md` should link to the relevant `src/board/tasks/*.md` entries
...
- `src/docs/README.md` lists:
  - all phase docs under `src/board/phases/`
  - research docs under `src/storage/research/`
- every phase doc includes a “Phase NN tasks” section pointing to `src/board/tasks/`
...
- `src/board/tasks/06-05-docs-sync-checklist.md`
- `src/docs/README.md`
- `src/docs/bilu-cli.md`
