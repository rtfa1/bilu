...
Task: `src/board/tasks/05-06-persistence-tests.md`

This plan adds non-interactive tests for persistence (editing markdown + regenerating derived outputs) without relying on the TUI. It follows `src/storage/research/shell-only-cli-advanced-notes.md`: command-oriented tests, deterministic output, atomic writes, and no runtime third-party deps.
...
- `src/board/tasks/05-06-persistence-tests.md`
- `src/board/phases/05-persistence-and-editing.md`
- `src/board/tasks/05-01-edit-status-in-markdown_imp.md`
- `src/board/tasks/05-02-edit-priority-in-markdown_imp.md`
- `src/board/tasks/05-05-file-locking-and-concurrency_imp.md`
