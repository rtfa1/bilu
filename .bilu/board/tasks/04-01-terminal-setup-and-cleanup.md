...
Task: `src/board/tasks/04-01-terminal-setup-and-cleanup.md`

This implementation plan defines a safe, portable way to enter/exit full-screen TUI mode for `bilu board --tui`, without leaving the user’s terminal in a broken state. It follows `src/storage/research/shell-only-cli-advanced-notes.md` and the terminal control patterns documented in `src/board/phases/04-interactive-tui.md`.
