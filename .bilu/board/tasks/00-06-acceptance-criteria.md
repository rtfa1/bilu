...
Task: `src/board/tasks/00-06-acceptance-criteria.md`

This implementation plan turns the “acceptance criteria” list into a versioned, test-backed contract. It aligns with `src/storage/research/shell-only-cli-advanced-notes.md` by keeping tests command-oriented (Bats-style without deps), enforcing exit codes (`0/1/2`), and ensuring output is stable under `NO_COLOR`.
...
3) `src/board/tasks/00-06-acceptance-criteria.md` becomes the single checklist for “board v1 done”.
...
- `src/board/tasks/00-06-acceptance-criteria.md`
