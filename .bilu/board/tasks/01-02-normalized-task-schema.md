...
Task: `src/board/tasks/01-02-normalized-task-schema.md`
...
Per `src/board/tasks/02-06-internal-record-format.md`, define a single strict TSV with stable column order.
